        ...
        <nav class="navbar bg-light navbar-light">
            ...
            <div class="d-flex align-items-center ms-4 mb-4">
                <div class="position-relative">
                    <img class="rounded-circle" src="{{asset('asset/img/toons.jpg')}}" alt="" style="width: 40px; height: 40px;">
...
{{--                        <a href="{{url('profile')}}" class="dropdown-item">View</a>--}}
{{--                        <a href="{{url('profile/create')}}" class="dropdown-item">Edit</a>--}}
